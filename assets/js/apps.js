...
NN_FRAMEWORK.Menu = function () {
	...
	$(window).scroll(function () {
		var cach_top = $(window).scrollTop();
		var heaigt_header = $('.header').height() + $('.w-menu-res').height();

		if (cach_top >= heaigt_header) {
			if (!$('.w-menu-res').hasClass('fix_head animate__animated animate__fadeIn')) {
				$('.w-menu-res').addClass('fix_head animate__animated animate__fadeIn');
			}
		} else {
			$('.w-menu-res').removeClass('fix_head animate__animated animate__fadeIn');
		}
	});
	...
	if (isExist($('nav#menu'))) {
		...
		$(".chinhanh-contain .js--chinhanh-item").click(function (e) {
			$(".chinhanh-contain .js--chinhanh-item").removeClass('active');
			...
			$.ajax({
				...
				success: function (result) {
					$('.show-chi-nhanh').html(result);
				}
			});
		});

		if ($(".chinhanh-contain .js--chinhanh-item").length > 0) {
			$(".chinhanh-contain .js--chinhanh-item").first().click();
		}
	...
	$('.icon_menu_mobi,.close_menu,.menu_baophu,#mmenu_trigger').click(function () {
...
NN_FRAMEWORK.Search = function () {
	if (isExist($('.icon-search'))) {
		$('.icon-search').click(function () {
			...
			$('.icon-search i').toggleClass('fa-sharp fa-regular fa-xmark');
		});
	}
...
NN_FRAMEWORK.Scrolltoc = function(){
	...
	{
		var margintop=3;
		$(".info_news").css({marginTop: margintop});
	}
