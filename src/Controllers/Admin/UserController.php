...
class UserController
{
    ...
    {
        // $2y$10$07oarjByDqko0.cW3AnQx.U2FlhAscS4OLsMVoGEPAGudZUYtkPz2
    ...
    public function delete(Request $request)
    {
        ...
        // response()->redirect(url('admin', ['com' => $com, 'act' => 'man']));
        transfer('Xóa tài khoản thành viên thành công', 1, url('user'));
