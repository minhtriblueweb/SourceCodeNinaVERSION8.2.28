                ...
                @foreach ($newsnb as $k => $value)
                    <div class="newsnb-box hover-box">
                        <div class="newsnb-image">
                            <a class="scale-img hover-img" href="{{ url('slugweb', ['slug' => $value['slugvi']]) }}"
                                title="{{ $value['namevi'] }}">
                                <img onerror="this.src='assets/images/noimage.png';"
                                    src="{{ assets_photo('news', '500x500x1', $value['photo'], 'thumbs') }}" alt="logo"
                                    title="logo" width="600" height="250" />
                            </a>
                        </div>
