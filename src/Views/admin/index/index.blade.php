                    ...
                    <div class="card-body">
                        <div class="row text-sm">
                            <div class="col-xl-3 col-md-6">
                                <a class="my-info-box info-box mb-lg-0" href="{{url('admin',['com'=>'setting','act'=>'man','type'=>'cau-hinh'])}}" title="Cấu hình website">
                                    <span class="my-info-box-icon info-box-icon bg-primary"><i class="ti ti-world"></i></span>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <a class="my-info-box info-box mb-lg-0" href="{{url('admin',['com'=>'user-admin','act'=>'man','type'=>'tai-khoan'])}}" title="Tài khoản">
                                    <span class="my-info-box-icon info-box-icon bg-danger"><i class="ti ti-users"></i></span>
                                    <div class="info-box-content text-dark">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <a class="my-info-box info-box mb-lg-0" href="{{url('admin',['com'=>'user-admin','act'=>'man','type'=>'tai-khoan'])}}?changepass=1"
                                    title="Đổi mật khẩu">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <a class="my-info-box info-box mb-lg-0" href="{{url('admin',['com'=>'newsletters','act'=>'man','type'=>'lien-he'])}}" title="Thư liên hệ">
                                    <span class="my-info-box-icon info-box-icon bg-info"><i class="ti ti-address-book"></i></span>
                                    <div class="info-box-content text-dark">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row text-sm">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <a class="my-info-box info-box mb-lg-0 bg-danger" href="extensions/man/hotline" title="Điện thoại">
                                    <span class="my-info-box-icon info-box-icon info-box-icon-setting"><i
                            ...
                            @foreach ($browser ?? [] as $value)
                                <li class="mb-3 pb-1 d-flex last:!mb-0">
                                    <div class="d-flex w-50 align-items-center me-3">
                                        <img onerror=this.src='@asset("assets/admin/img/icons/brands/browser.png")'; src="../assets/admin/img/icons/brands/{{ Func::browser($value['browser'], $countBrowser)['img'] }}.png" alt="{{ Func::browser($value['browser'], $countBrowser)['name'] }}" class="me-3" width="35" />
                                        <div>
                                            <h6 class="mb-0">
